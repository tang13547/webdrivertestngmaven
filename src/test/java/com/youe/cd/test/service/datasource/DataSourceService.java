...
public class DataSourceService {
    public static void createDataSource(WebDriver driver, String dsType, String dsEngine, String dsName) throws Exception {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//span[text()='" + dsEngine + "']")).click();
        Thread.sleep(1000);
