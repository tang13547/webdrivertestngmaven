...
public class FtpUtil {
    //ftp服务器地址
    public String hostname = "192.168.30.232";
    //ftp服务器端口号默认为21
    public Integer port = 21 ;
    //ftp登录账号
    public String username = "ftpuser";
    //ftp登录密码
    public String password = "ftpuser@123";
     ...
     * @return
     */
    public boolean uploadFile(String originfilename, String pathname, String fileName){
        boolean flag = false;
    ...
    public static void main(String[] args) {
        ...
        //ftp.downloadFile("test2/subftp", "testfile3112n.txt", "F:\\");
