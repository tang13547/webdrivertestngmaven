...
import com.youe.cd.test.util.Locator.ByType;  //包含导入了自定义的ByType枚举类型
...
public class XmlReadUtil {
	...
	public  HashMap<String, Locator> readXMLDocument(String path, String pageName) {
		...
		logger.info("----------开始解析UILibrary.xml对象库-----------");
		logger.info("开始读取："+pageName+"页信息");
